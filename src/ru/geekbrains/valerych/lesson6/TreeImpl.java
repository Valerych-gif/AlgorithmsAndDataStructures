...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E> {
    ...
    public boolean add(E value) {
        ...
        NodeInfo nodeInfo = doFind(value);
        Node<E> current = nodeInfo.current;
        if (current != null) {
            return false;
        }

        if (maxDepth>0&&nodeInfo.depth>=maxDepth){
            return false;
        }

        Node<E> parent = nodeInfo.parent;
        if (parent != null) {
    ...
    private NodeInfo doFind(E value) {
        ...
        while (current != null) {
            ...
            if (current.getValue().equals(value)) {
                return new NodeInfo(current, previous, currentDepth);
            }
        ...
        return new NodeInfo(null, previous, currentDepth);
    }

    @Override
    public boolean remove(E value) {
        NodeInfo nodeInfo = doFind(value);
        Node<E> removedNode = nodeInfo.current;
        Node<E> parentNode = nodeInfo.parent;
    ...
    private class NodeInfo {
        ...
        public NodeInfo(Node<E> current, Node<E> parent, int depth) {
